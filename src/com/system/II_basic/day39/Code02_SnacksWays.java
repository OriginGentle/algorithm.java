package com.system.II_basic.day39;
...
public class Code02_SnacksWays {
    ...
    public static int process(int[] arr, int index, int rest) {
        ...
        int ways1 = process(arr, index + 1, rest);
        int ways2 = process(arr, index + 1, rest - arr[index]);
        return ways1 + (ways2 == -1 ? 0 : ways2);
    }
    ...
    // dp[i][j] : arr[0...i],凑成的体积刚好为j，一共有多少种方法
