package com.system.II_basic.day16;

import com.system.II_basic.day16.graph.Edge;
import com.system.II_basic.day16.graph.Node;
 ...
 * @Description Dijkstra算法 有向无负权重图
...
public class Code09_Dijkstra {
    ...
    public static class NodeHeap {
        ...
        private HashMap<Node, Integer> heapIndexMap; // key:某一个节点 value:堆中的位置
        ...
        public void addOrUpdateOrIgnore(Node node, int distance) {
            if (inHeap(node)) {
                ...
                heapInsert(node, heapIndexMap.get(node)); // 更新后记录只能变小或者不变
            }
            if (!isEntered(node)) {
                nodes[size] = node;
        ...
        public NodeRecord pop() {
            ...
            swap(0, size - 1);
            heapIndexMap.put(nodes[size - 1], -1); // 修改value为-1，代表节点曾经进来过
