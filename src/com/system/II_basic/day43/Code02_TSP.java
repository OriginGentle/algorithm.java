package com.system.II_basic.day43;
...
public class Code02_TSP {
    ...
    public static int func2(int[][] matrix, int cityStatus, int start) {
        ...
        //  &  : 1100110
        // 结果 : 0000010
        if (cityStatus == (cityStatus & (~cityStatus + 1))) { // 只有一座城市了
            return matrix[start][0];
        }
        // 把start位的1去掉，
        cityStatus &= (~(1 << start));
