...
public class Problem_0639_DecodeWaysII {
    ...
    public static int func(char[] str, int i) {
        ...
        if (str[i] != '*') {
            ...
            if (str[i + 1] != '*') {
                ...
                int p2 = 0;
                if (str[i] < '3') {
                    p2 = func(str, i + 2) * (str[i] == '1' ? 9 : 6);
                }
                return p1 + p2;
            }
        } else { // str[i] == '*' 1~9
            // i 单转 9种
            int p1 = 9 * func(str, i + 1);
            if (i + 1 == str.length) {
                return p1;
            }
            if (str[i + 1] != '*') {
                ...
                // * 8 18
                // * 9 19
                int p2 = (str[i + 1] < '7' ? 2 : 1) * func(str, i + 2);
                return p1 + p2;
            } else { // str[i+1] == *
                // **
                // 11~19 9
    ...
    public static int numDecodings1(String s) {
        ...
        return (int) ways1(s.toCharArray(), 0, dp);
    }
