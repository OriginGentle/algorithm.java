package com.system.D_weekly.code_2022_08_4_week;

import java.util.ArrayList;

/**
 * @author ycb
 * @date 2022/8/27-13:34
 * @desc 来自微软
 * 给定两个数组A和B，比如
 * A = { 0, 1, 1 }
 * B = { 1, 2, 3 }
...
public class Code05_TravelMinFuel {
    ...
    private static void dfs(ArrayList<ArrayList<Integer>> graph, int cur,
                            int[] dfn, int[] size, int[] cost) {
