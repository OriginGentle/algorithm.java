package com.system.D_weekly.code_2023_01_1_week;
 ...
 * @author ycb
 * @date 2023/1/8-16:59
 * @desc 有 n 名工人。 给定两个数组 quality 和 wage ，
...
public class Code03_MinimumCostToHireKWorkers {
    ...
    public double mincostToHireWorkers(int[] quality, int[] wage, int k) {
        ...
        // 根据 垃圾指数 排序 （要价 / 能力）
        Arrays.sort(employees, Comparator.comparing(a -> a.rubbishDegree));
        // 门槛堆
        PriorityQueue<Integer> minTops = new PriorityQueue<>((a, b) -> b - a);
