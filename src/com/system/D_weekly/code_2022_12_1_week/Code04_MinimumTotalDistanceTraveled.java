package com.system.D_weekly.code_2022_12_1_week;
...
/**
 * @author ycb
 * @date 2022/12/10-19:54
 * @desc X轴上有一些机器人和工厂。给你一个整数数组robot，其中robot[i]是第i个机器人的位置
    ...
    public static long minimumTotalDistance3(List<Integer> robot, int[][] factory) {
        ...
        for (int j = 0; j < m; j++) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                add += Math.abs(robot.get(i) - factory[j][0]);
