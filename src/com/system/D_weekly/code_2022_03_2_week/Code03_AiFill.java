...
public class Code03_AiFill {
    ...
    public static class TrieNode {
        private String word;
        private int times;
        private HashMap<String, TrieNode> nexts;
        ...
        public TrieNode(String s) {
            ...
            times = 1;
            nexts = new HashMap<>();
            nextRanks = new TreeSet<>((a, b) -> a.times != b.times ?
                    b.times - a.times : a.word.compareTo(b.word));
        }
    }
        ...
        private void fill(String sentence) {
            ...
            for (String word : sentence.split(" ")) {
                if (!cur.nexts.containsKey(word)) {
                    ...
                    cur.nexts.put(word, next);
                    cur.nextRanks.add(next);
                } else {
                    next = cur.nexts.get(word);
