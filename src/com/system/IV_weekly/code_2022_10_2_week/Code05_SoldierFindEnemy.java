package com.system.IV_weekly.code_2022_10_2_week;
...
public class Code05_SoldierFindEnemy {
    ...
    public static int minCost1(char[][] map, int a, int b) {
        ...
        int p1 = process(map, si, sj, 0, a, b, visited);
        int p2 = process(map, si, sj, 1, a, b, visited);
        int p3 = process(map, si, sj, 2, a, b, visited);
        int p4 = process(map, si, sj, 3, a, b, visited);
    ...
    public static int process(char[][] map,
        ...
        int p0 = process(map, si - 1, sj, 0, a, b, visited);
        int p1 = process(map, si + 1, sj, 1, a, b, visited);
        int p2 = process(map, si, sj - 1, 2, a, b, visited);
        int p3 = process(map, si, sj + 1, 3, a, b, visited);
    ...
    public static void add(int i, int j, int d,
                           int preD, int preC,
                           int a, int b,
                           char[][] map,
                           boolean[][][] visited,
