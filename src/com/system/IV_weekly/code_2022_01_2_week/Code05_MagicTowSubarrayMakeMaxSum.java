package com.system.IV_weekly.code_2022_01_2_week;
...
public class Code05_MagicTowSubarrayMakeMaxSum {
    ...
    public static int maxSum2(int[] arr) {
        ...
        if (n == 1) {
            return Math.max(arr[0], 10 * arr[0]);
        }
        // dp[i] :
        // 1) arr[0...i]原始累加和
        // 2) dp[i-1] + arr[i]
        ...
        // arr[0..i]范围上，可以没有10倍区域、或者有10倍区域但是最多有一个的情况下，最大累加和是多少？
        ...
        //
        //         b : arr[i]在10倍区域里
        //             甲：arr[0..i-1]没有10倍区域，arr[i]自己在10倍区域，arr[0..i-1] + 10 * arr[i]
