...
/**
 * @author ycb
 * @date 2022/12/31-21:14
 * @desc 对于某些非负整数 k ，如果交换 s1 中两个字母的位置恰好 k 次
...
public class Code06_KSimilarStrings {
    ...
    public static void add(String add, String s2, int cost, int index,
                           PriorityQueue<Node> heap, HashSet<String> visited) {
