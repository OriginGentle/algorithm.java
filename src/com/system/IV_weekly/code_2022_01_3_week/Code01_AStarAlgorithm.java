package com.system.IV_weekly.code_2022_01_3_week;
...
public class Code01_AStarAlgorithm {
    ...
    private static void add1(int pre, int row, int col, int n, int m, int[][] map, boolean[][] closed,
    ...
    private static void add2(int pre, int row, int col, int targetX, int targetY, int n, int m, int[][] map,
    ...
    private static int distance(int curX, int curY, int targetX, int targetY) {
