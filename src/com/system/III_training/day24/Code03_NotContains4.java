package com.system.III_training.day24;
    ...
    public static void main(String[] args) {
        ...
        for (long i = 0; i <= max; i++) {
            ...
            if (isNot4(i) && notContains4Nums2(i) != notContains4Nums3(i)) {
                ...
                System.out.println(notContains4Nums1(i));
                System.out.println(notContains4Nums2(i));
                System.out.println(notContains4Nums3(i));
                break;
            }
        }
        System.out.println("如果没有打印Oops说明验证通过");

        long num = 8173528638998L;
        long start;
        long end;
