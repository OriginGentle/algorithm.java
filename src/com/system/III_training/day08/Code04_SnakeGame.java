package com.system.III_training.day08;
 ...
 * @description 给定一个矩阵matrix，值有正、负、0
...
public class Code04_SnakeGame {
    ...
    public static Info func(int[][] matrix, int i, int j) {
        if (j == 0) {
