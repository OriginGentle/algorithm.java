package com.system.III_training.day01;
 ...
 * @Description 给定一个数组arr，你可以在每个数字之前决定+或者-
 * 但是必须所有数字都参与，给定一个数target，请问最后算出target的方法数是多少？
 */
public class Code07_TargetSum {
    ...
    public static int findTargetSumWays3(int[] arr, int target) {
        ...
        return target > sum || ((target & 1) ^ (sum & 1)) != 0 ? 0 : subset(arr, (target + sum) >> 1);
    }
