package com.system.III_training.day09;
...
public class Code01_LightProblem {
    ...
    // 当前在哪个位置做选择，nextIndex - 1位置
    // 当前位置：cur = nextIndex - 1
    // preStatus : 代表cur - 1位置的状态
    // curStatus : 当前灯的状态
    // 潜台词： 0....cur-2位置上的灯是全亮的！
    ...
    /**
     * 下一个位置是：nextIndex
     * 当前位置是：nextIndex - 1 --> curIndex --> curStatus
