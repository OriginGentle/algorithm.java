package com.system.III_training.day13;
...
public class Code03_ScrambleString {
    ...
    public static boolean isScramble2(String s1, String s2) {
        ...
        int N = str1.length;
        // dp[i][j][k] = 0 process2(i,j,k)状态之前没有算过的
        // dp[i][j][k] = -1 process2(i,j,k)状态之前算过的,返回值是false
        // dp[i][j][k] = 1 process2(i,j,k)状态之前算过的,返回值是true
    ...
    public static boolean isScramble3(String s1, String s2) {
        ...
        // L1的取值范围是[0,N-size]，因为从L1出发往右长度为size的子串，L1是不能从N-size+1出发的，这样往右就不够size个字符了
        // L2的取值范围同理
