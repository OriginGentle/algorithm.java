package com.weekly.code_2022_10_3_week;
...
public class Code03_AddToSorted {
    ...
    public static int minOp1(int[] arr) {
        ...
        return process(0, max, new boolean[max + 1], arr);
    }

    public static int process(int num, int max, boolean[] op, int[] arr) {
        if (num == max + 1) {
            int cnt = 0;
            ...
            op[num] = true;
            int p1 = process(num + 1, max, op, arr);
            op[num] = false;
            int p2 = process(num + 1, max, op, arr);
    ...
    public static class DynamicSegmentTree {
        ...
        private void update(Node c, int l, int r, int s, int e) {
            if (s <= l && r <= e) {
                ...
                int m = (l + r) >> 1;
                pushDown(c, m - l + 1, r - m);

                if (s <= m)
                    update(c.left, l, m, s, e);

                if (e > m)
                    update(c.right, m + 1, r, s, e);
    ...
    public static final int MAX = 8000000;
    public static int[] sum = new int[MAX];
    public static boolean[] set = new boolean[MAX];
    public static int[] left = new int[MAX];
    public static int[] right = new int[MAX];
    public static int[] lChild = new int[MAX];
    public static int[] rChild = new int[MAX];
