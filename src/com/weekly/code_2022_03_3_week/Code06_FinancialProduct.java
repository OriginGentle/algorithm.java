package com.weekly.code_2022_03_3_week;
 ...
 * @description https://leetcode-cn.com/contest/cnunionpay-2022spring/problems/I4mOGz/
 * 来自银联编程比赛
...
public class Code06_FinancialProduct {
    ...
    public int maxInvestment(int[] arr, int limit) {
        ...
        while (limit > 0 && r != -1) {
            ...
            if (limit >= all) {
                ...
                int rest = limit / teams;
                ans += get(big, big - rest + 1, teams) + (long) (big - rest) * (long) (limit % teams);
                ans %= mod;
                limit = 0;
            }
            r = l;
    ...
    public long get(long up, long down, long num) {
