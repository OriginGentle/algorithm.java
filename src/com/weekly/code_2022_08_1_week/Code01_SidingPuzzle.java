 ...
 * @author ycb
 * @date 2022/8/5-09:36
 * @desc https://leetcode.cn/problems/sliding-puzzle/
 */
public class Code01_SidingPuzzle {

    public static final int b6 = 100000;

    public static final int b5 = 10000;
    ...
    public static int slidingPuzzle1(int[][] board) {
        HashSet<Integer> cmt = new HashSet<>();
        int from = board[0][0] * b6 + board[0][1] * b5 + board[0][2] * b4
                + board[1][0] * b3 + board[1][1] * b2 + board[1][2];
    ...
    public static int nexts(int from) {
        ...
        if (a == 0) {
            ...
            nexts[0] = from + (c - f) + (f - c) * b4;
            nexts[1] = from + (e - f) + (f - e) * b2;
            return 2;
        }
    }
