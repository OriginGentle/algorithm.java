 ...
 * @description 如果只给定一个二叉树前序遍历数组pre和中序遍历数组in，
...
public class Code01_PreAndInArrayToPosArray {
    ...
    public static void process2(int[] pre, int L1, int R1, int[] in, int L2, int R2, int[] pos, int L3, int R3, HashMap<Integer, Integer> map) {
        if (L1 > R1) {
            return;
        }
        if (L1 == R1) {
